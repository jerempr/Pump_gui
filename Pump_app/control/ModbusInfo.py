...
#                         Ihm_parameters = self.Get_Ihm_parameters()
...
#                         self.SystemSignal.emit(Ihm_parameters,GraisseOn,str(self.niveau_cuve),self.defautelec_message,self.marchep1,self.marchep2)
#                         sleep(1)
